...
public class Modulo09_Account {
	private int number;
	private String holder;
	private double balance;
	public static final double WithdrawTAX = 5.00;
	
	public Modulo09_Account() {
	}
	
// Source > Generate Constructor using Fields
	public Modulo09_Account(int number, String holder) {  // , double accBalance
		this.number = number;
		this.holder = holder;
		// this.accBalance = accBalance;  // já é 0 neste construtor por não ser informado nele
	}
// Source > Generate Constructor using Fields	
	public Modulo09_Account(int number, String holder, double initialDeposit) {
		super();
		this.number = number;
		this.holder = holder;
