...
public class Modulo09_Product_77 {
...
// Construtores
	// construtor padrao
	public Modulo09_Product_77() {
	}
	
	public Modulo09_Product_77 (String name, double price, int quantity) { 
		this.name = name; 
		this.price = price; 
		this.quantity = quantity; 
	}

	public Modulo09_Product_77 (String name, double price) { 
		this.name = name; 
		this.price = price; 
	}
