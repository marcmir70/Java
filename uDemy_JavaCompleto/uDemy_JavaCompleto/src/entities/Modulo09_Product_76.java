...
public class Modulo09_Product_76 {
...
// sobrecarga : inclusao de construtor padrao
	public Modulo09_Product_76() {
	}
	
	public Modulo09_Product_76 (String name, double price, int quantity) { // por convenção, usamos os mesmos nomes dos atributos
		this.name = name; 
		this.price = price; 
...
// sobrecarga : disponibilizar mais de uma versao da mesma operacao	
	public Modulo09_Product_76 (String name, double price) { // por convenção, usamos os mesmos nomes dos atributos
		this.name = name; 
		this.price = price; 
