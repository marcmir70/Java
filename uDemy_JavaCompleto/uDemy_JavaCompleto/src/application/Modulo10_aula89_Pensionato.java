...
import entities.Modulo10_Aula89_Reserva;

public class Modulo10_aula89_Pensionato {
	public static void main(String[] args) {
		...
		double valor;
		int meses;
		Modulo10_Aula89_Reserva[] vetor = new Modulo10_Aula89_Reserva[9];
...
// pede numero do quarto a reserva e valida se ja foi reservado
			...
			vetor[numeroQuarto - 1] = new Modulo10_Aula89_Reserva(nome, email, valor, meses);
		}
