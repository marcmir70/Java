...
import entities.Modulo10_Room;

public class Modulo10_aula89_exercDeFixacao {
	...
	public static void main(String[] args) {
		...
		String name, eMail;
		Modulo10_Room[] vect = new Modulo10_Room[10]; // estava Room vect[] = ... e, na solucao, Rent[] vect = new Rent[10]; - mas seria Rent[9]
		...
		for (int i=0; i<rooms; i++) {
			...
			vect[roomNumber-1] = new Modulo10_Room(name, eMail);
		}
